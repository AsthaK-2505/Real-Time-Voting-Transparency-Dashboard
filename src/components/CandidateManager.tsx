...
const CandidateManager: React.FC<CandidateManagerProps> = memo(
  ({ candidates, onAddCandidate, onUpdateCandidate, onDeleteCandidate }) => {
    ...
    const handleDelete = (id: string) => {
      ...
      if (
        window.confirm(
          "Are you sure you want to delete this candidate? All their votes will be lost."
        )
      ) {
      ...
      <div className="candidate-manager">
        ...
        {(isAdding || editingId) && (
          <form className="candidate-form" onSubmit={handleSubmit}>
            ...
            <div className="form-group">
              <label htmlFor="candidate-color">Chart Color</label>
